...
dat_bergplot<-na.omit(dat_ihoma[,c("key","sex","cgly_st_18yr",
                                   "homa_beta_18","homa_sens_18",
                                   "homa_beta_12","homa_sens_12",
                                   "homa_beta_6","homa_sens_6" ,
                                   "age_6","age_12","age_18",
                                   "b_gage_w")])
...
3. ###### data for test of significance of curves #################
test18<-na.omit(dat_bergplot[,c("key","homa_sens_18","homa_beta_18","class","sex")])
test18$homa_sens_18<-log2(test18$homa_sens_18)
test18$homa_beta_18<-log2(test18$homa_beta_18)

test12<-na.omit(dat_bergplot[,c("key","homa_sens_12","homa_beta_12","class","sex")])
test12$homa_sens_12<-log2(test12$homa_sens_12)
test12$homa_beta_12<-log2(test12$homa_beta_12)

test6<-na.omit(dat_bergplot[,c("key","homa_sens_6","homa_beta_6","class","sex")])
test6$homa_sens_6<-log2(test6$homa_sens_6)
test6$homa_beta_6<-log2(test6$homa_beta_6)
#test18$homa_sens_18_z<-(test18$homa_sens_18-mean(test18$homa_sens_18))/sd(test18$homa_sens_18)
4 ## data for trajectory plot median data 
tapply(test12$homa_sens_12,test12$class,median)
tapply(test12$homa_beta_12,test12$class,median)
tapply(test18$homa_sens_18,test18$class,median)
tapply(test18$homa_beta_18,test18$class,median)
tapply(test6$homa_beta_6,test6$class,median)
tapply(test6$homa_sens_6,test6$class,median)
dat_median_pmns<-read.csv("Data/data_median_PMNS.csv")
dat_median_pmns$Time<-factor(dat_median_pmns$Time)
dat_median_pmns$Class<-factor(dat_median_pmns$Class)
##### data for linear mixed effect model #######################
#### Rate of change of HOMA-B, HOMA-S and disposition index 
