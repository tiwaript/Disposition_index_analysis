...
dat_lme<-dat_ihoma[,c(1,3,141,14:16,112,114,134,127,117,131,113,115,130)]
...
dat_lme_long<-reshape(dat_lme,varying = c("age_6","age_12","age_18","homasens_6","homasens_12","homasens_18",
